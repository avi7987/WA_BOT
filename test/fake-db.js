...
const DEFAULTS = {
  ...
  pa_list_items: () => ({ id: randomUUID(), tags: [], location_text: null, area: null, note: null, created_at: new Date().toISOString() }),
  pa_item_refs: () => ({ created_at: new Date().toISOString() }),
...
const UNIQUE = {
  ...
  pa_settings: ['key'],
  pa_item_refs: ['user_id', 'n'],
  pa_req_refs: ['user_id', 'n'],
};
